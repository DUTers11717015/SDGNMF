...
xlabel('k');
ylabel('准确率（%）')
legend('SCNMFS','CNMF','NMF','原始空间');
title('COIL');

% PIE数据集上的准确率
k=[2:10];

PIE_scnmfs=[94.00 90.59 86.88 84.24 78.85 73.19 70.76 68.29 67.68];   % 最高值
...
Yale_scnmfs=[99.05 98.59 93.88 90.24 89.85 87.95 87.20 86.29 83.05];   % 最高值
